...
const ALL_COLORS = ['#b82105', '#ec4899', '#10b981', '#f59e0b', '#3b82f6', '#06b6d4']
  ...
  const CustomTooltip = ({ active, payload }: any) => {
    ...
    return (
      <div style={{
        ...
        <div style={{ color: '#94a3b8' }}>Avg CAPD: <span style={{ color: '#b82105', fontWeight: 700 }}>{d.avg_capd}</span></div>
  ...
  return (
    <div className="glass-card" style={{ padding: '20px 16px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        ...
        <span style={{ fontSize: 11, color: 'var(--text-muted)', background: 'rgba(184, 33, 5, 0.1)', padding: '3px 10px', borderRadius: 6, border: '1px solid rgba(184, 33, 5, 0.2)' }}>
          Target: 40 calls/day
        </span>
      </div>
      <ResponsiveContainer width="100%" height={240}>
        <BarChart data={chartData} margin={{ top: 4, right: 16, left: -16, bottom: 0 }}>
          ...
          <ReferenceLine y={40} stroke="rgba(184, 33, 5, 0.5)" strokeDasharray="6 3" label={{ value: '40', position: 'right', fill: '#b82105', fontSize: 11 }} />
